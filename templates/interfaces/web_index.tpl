...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="templates/interfaces/css/bootstrap.min.css" rel="stylesheet">

        <!-- MetisMenu CSS -->
        <link href="templates/interfaces/css/metisMenu.min.css" rel="stylesheet">

        <!-- Timeline CSS -->
        <link href="templates/interfaces/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="templates/interfaces/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="templates/interfaces/css/morris.css" rel="stylesheet">

        <!-- Custom Fonts -->
        <link href="templates/interfaces/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <!-- jQuery -->
        <script src="templates/interfaces/js/jquery.min.js"></script>

        <!-- Bootstrap Core JavaScript -->
        <script src="templates/interfaces/js/bootstrap.min.js"></script>

        <!-- Metis Menu Plugin JavaScript -->
        <script src="templates/interfaces/js/metisMenu.min.js"></script>

        <!-- Morris Charts JavaScript -->
        <script src="templates/interfaces/js/raphael.min.js"></script>
        <script src="templates/interfaces/js/morris.min.js"></script>
        <script src="templates/interfaces/js/morris-data.js"></script>

        <!-- Custom Theme JavaScript -->
        <script src="templates/interfaces/js/startmin.js"></script>
